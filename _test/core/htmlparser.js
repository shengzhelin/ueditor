...
test( '普通標簽處理', function() {
    var root = UE.htmlparser('<i>sdfsdfsdfsf</i>');
    equals(root.toHtml(),'<i>sdfsdfsdfsf</i>','單個普通標簽');
    root = UE.htmlparser('<i>sdf<b>sdfsdsd</b>fsdfsf</i>');
    equals(root.toHtml(),'<i>sdf<b>sdfsdsd</b>fsdfsf</i>','多個普通標簽');
    root = UE.htmlparser('<i dsf="sdf" sdf="wewe" readonly >sdf</i>');
    ua.checkSameHtml(root.toHtml(),'<i dsf="sdf" sdf="wewe" readonly=\"\" >sdf</i>','添加屬性的標簽');
    root = UE.htmlparser('<img src="file:///C:/DOCUME~1/DONGYA~1/LOCALS~1/Temp/msohtmlclip1/01/clip_image002.jpg" width="553" height="275" />');
    ua.checkSameHtml(root.toHtml(),'<img src="file:///C:/DOCUME~1/DONGYA~1/LOCALS~1/Temp/msohtmlclip1/01/clip_image002.jpg" width="553" height="275" />','img標簽');
});

test( '特殊標簽處理', function() {
    ...
    equals(root.toHtml().replace(/[ ]+>/g,'>'),'<script type="text/javascript" charset="utf-8" src="editor_api.js"></script>','script標簽');
    root = UE.htmlparser('<table width="960"><tbody><tr><td width="939" valign="top"><br></td></tr></tbody></table><p><br></p>');
    equals(root.toHtml().replace(/[ ]+>/g,'>'),'<table width="960"><tbody><tr><td width="939" valign="top"><br/></td></tr></tbody></table><p><br/></p>','br標簽');
...
//
////    root = UE.htmlparser('<tr></td>123');
////    equals( root.toHtml().toLowerCase(), '<table><tbody><tr></tr></tbody></table>123', '<tr></td>123--td閉標簽後面有文字' );//TODO 1.2.6
//
...
//    equals( root.toHtml().toLowerCase(), '123', '123</tr>--刪除tr前後的標簽，前面有文本' );
//    /*補全table前面的標簽*/
//    root = UE.htmlparser('123</table>');
//    equals( root.toHtml().toLowerCase(), '123', '123</table>--刪除table前後的標簽，前面有文本' );
//    /*覆雜結構*/
...
test( '補全不完整li', function() {
    ...
    /*補li開始標簽*/
    root = UE.htmlparser('</li>123');
    equals(root.toHtml().replace(/[ ]+>/g,'>'), '123', '</li>123--刪掉標簽' );
});
