...
test( 'horizontal', function() {
    ...
    setTimeout(function(){
        ...
        equal( editor.queryCommandState( "horizontal" ), 0, "邊界不在table里" );
        editor.execCommand( 'horizontal' );
        var spase = ua.browser.ie?'':'<br>';
        equal( ua.getChildHTML( db ), "<p><strong><em></em></strong></p><hr><p>m"+spase+"</p>", "邊界不在table里" );
        start();
    },50);
    stop();
} );
test( 'horizontal_br', function() {//trace 3854
    ...
    editor.ready(function () {
        ...
        equal( ua.getChildHTML( editor.body.firstChild ), "<li><p>top</p><hr><br></li>", "在列表中插入分隔線，在分隔線後面添加p用於定位" );
        setTimeout(function(){
            te.dom.push(div);
            start();
        },50);
...
test( 'horizontal-delkeydown', function() {
    ...
    setTimeout(function(){
        ...
        setTimeout(function(){
            ...
            var spase = ua.browser.ie?'':'<br>';
            equal( ua.getChildHTML( db ), "<p><strong><em></em></strong></p><p>m"+spase+"</p>", "刪除分隔符" );
            start();
        },50);
    },50);
    stop();
...
test( '在列表中插入分隔線，回車符為p', function() {
    ...
    ua.manualDeleteFillData(editor.body);
    equal( ua.getChildHTML( body.firstChild ), "<li><p>top</p><hr><p></p></li>", "在列表中插入分隔線，在分隔線後面添加p用於定位" );

} );

//test( '在列表中插入分隔線，回車符為br', function() {
//
...
//        equal( ua.getChildHTML( body ), "<ol><li><p>top</p><hr><br></li></ol>", "在列表中插入分隔線，在分隔線後面添加p用於定位" );
//    } else {
//        equal( ua.getChildHTML( body ), "<ol><li><p>top</p><hr></li></ol>", "ff在列表中插入分隔線" );
//    }
//    te.dom.push(div);
//} );
...
test( 'horizontal in table', function() {
    ...
    setTimeout(function () {
        ...
        equal(editor.queryCommandState("horizontal"), -1, "邊界在table里");
        start();
    }, 50);
} );
//collapsed=true
test( 'horizontal&&collapsed', function() {
    ...
    editor.execCommand( 'horizontal' );
    var spase = ua.browser.ie?'':'<br>';
    equal( ua.getChildHTML( db ), "<p><strong><em>top</em></strong></p><hr><p>bottom"+spase+"</p>", "邊界不在table里" );
} );
//TODO 1.2.6
