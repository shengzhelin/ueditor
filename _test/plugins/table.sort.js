...
test(" trace 3715 sortTable", function () {
    ...
    equal(value, "21", "按數值從大到小排列");

    ut.sortTable(0, 'reversebynum');
    equal(table.getAttribute('data-sort-type'), "reversebynum", "data-sort-type屬性是否設置成功");
});
    ...
    setTimeout(function () {
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                equal(domUtils.hasClass(editor.body.firstChild.rows[0], 'firstRow'), true, '給第一行添加firstRow的類');
                start();
            }, 20);
        }, 20);
    }, 50);
...
test('contextMenu 表格逆序當前', function () {
    var editor = te.obj[0];
    var range = te.obj[1];
    stop();
    var lang = editor.getLang("contextMenu");
    editor.execCommand('cleardoc');
    var html = '<table><tbody><tr><td>Michael</td><td>1</td><td>康熙</td></tr><tr><td>ackson</td><td>4</td><td>承祜</td></tr><tr><td>{}</td><td>2</td><td>胤禮</td></tr><tr><td>&amp;*</td><td>3</td><td>襄嬪</td></tr></tbody></table>';
    ...
    setTimeout(function () {
        ...
        equal(menutable.childNodes.length, 7, '7個子項目');
        if (browser.gecko) {
            equal(menutable.textContent, lang.enablesort+lang.reversecurrent+lang.orderbyasc+lang.reversebyasc+lang.orderbynum+lang.reversebynum, '檢查menu顯示的字符');
        }
        else {
            equal(menutable.innerText.replace(/[\r\n\t\u200b\ufeff]/g, ''), lang.enablesort+lang.reversecurrent+lang.orderbyasc+lang.reversebyasc+lang.orderbynum+lang.reversebynum, '檢查menu顯示的字符');
        }
        ...
        ua.manualDeleteFillData(editor.body);
        ua.checkSameHtml(editor.body.firstChild.firstChild.innerHTML,'<tr class=\"firstRow\"><td>&amp;*</td><td>3</td><td>襄嬪</td></tr><tr><td>{}</td><td>2</td><td>胤禮</td></tr><tr><td>ackson</td><td>4</td><td>承祜</td></tr><tr><td>Michael</td><td>1</td><td>康熙</td></tr>', '表格內容逆序-選區閉合');
        var tds = editor.body.getElementsByTagName('td');
        var ut = editor.getUETable(editor.body.firstChild);
        ...
        setTimeout(function () {
            ...
            ua.manualDeleteFillData(editor.body);
            ua.checkSameHtml(editor.body.innerHTML,'<table><tbody><tr><td class=\"selectTdClass\">ackson</td><td>4</td><td>承祜</td></tr><tr><td class=\"selectTdClass\">{}</td><td>2</td><td>胤禮</td></tr><tr><td class=\"selectTdClass\">&amp;*</td><td>3</td><td>襄嬪</td></tr><tr><td>Michael</td><td>1</td><td>康熙</td></tr></tbody></table>', '表格內容逆序-選區不閉合');
...
test('contextMenu 按ASCII字符排序', function () {
    ...
    setTimeout(function () {
        ...
        ua.checkSameHtml(editor.body.innerHTML,'<table><tbody><tr><td>{}</td><td>2</td><td>胤禮</td></tr><tr><td>&amp;*</td><td>3</td><td>襄嬪</td></tr><tr><td>ackson</td><td>4</td><td>承祜</td></tr><tr><td>Michael</td><td>1</td><td>康熙</td></tr></tbody></table>', '選區閉合');
        var tds = editor.body.getElementsByTagName('td');
        var ut = editor.getUETable(editor.body.firstChild);
        var cellsRange = ut.getCellsRange(tds[0], tds[6]);
        ut.setSelected(cellsRange);
        ...
        setTimeout(function () {
            ...
            ua.manualDeleteFillData(editor.body);
            ua.checkSameHtml(editor.body.innerHTML,'<table><tbody><tr><td class=\" selecttdclass \">ackson</td><td>4</td><td>承祜</td></tr><tr><td class=\" selecttdclass\">&amp;*</td><td>3</td><td>襄嬪</td></tr><tr><td class=\" selecttdclass\">{}</td><td>2</td><td>胤禮</td></tr><tr><td>Michael</td><td>1</td><td>康熙</td></tr></tbody></table>', '表格內容逆序-選區不閉合');
            setTimeout(function () {
                document.getElementById('edui_fixedlayer').parentNode.removeChild(document.getElementById('edui_fixedlayer'));
                te.dom.push(editor.container);
//
...
test('contextMenu 按數值大小排序', function () {
    var editor = te.obj[0];
    var range = te.obj[1];
    stop();
    var lang = editor.getLang("contextMenu");
    ...
    setTimeout(function () {
        ...
        ua.manualDeleteFillData(editor.body);
        ua.checkSameHtml(editor.body.innerHTML, '<table data-sort-type=\"orderbynum\"><tbody><tr class=\"firstRow\"><td>Michael</td><td>1</td><td>康熙</td></tr><tr><td>{}</td><td>2</td><td>胤禮</td></tr><tr><td>&amp;*</td><td>3</td><td>襄嬪</td></tr><tr><td>ackson</td><td>4</td><td>承祜</td></tr></tbody></table>', '選區閉合');
        setTimeout(function () {
            document.getElementById('edui_fixedlayer').parentNode.removeChild(document.getElementById('edui_fixedlayer'));
            te.dom.push(editor.container);
            start();
...
test('contextMenu trace 3384: 按數值大小排序', function () {
    var editor = te.obj[0];
    var range = te.obj[1];
    stop();
    var lang = editor.getLang("contextMenu");
    ...
    setTimeout(function () {
        ...
        var numIndex = ua.getContextmenuIndexByName(menutable.childNodes,lang.orderbynum);
        ua.click(menutable.childNodes[numIndex]);//num升
        ua.checkSameHtml(editor.body.innerHTML,'<table><tbody><tr><td>Michael</td><td>1</td><td>康熙</td></tr><tr><td>{}</td><td>2</td><td>胤禮</td></tr><tr><td>&amp;*</td><td>3</td><td>襄嬪</td></tr><tr><td>ackson</td><td>4</td><td>承祜</td></tr></tbody></table>', '選區不閉合');
        ...
        setTimeout(function () {
            ...
            if(!ua.browser.gecko){
                ua.checkSameHtml(editor.body.innerHTML,'<table><tbody><tr><td>&amp;*</td><td class=\" selecttdclass\">3</td><td>襄嬪</td></tr><tr><td>{}</td><td class=\" selecttdclass\">2</td><td>胤禮</td></tr><tr><td>Michael</td><td class=\" selecttdclass\">1</td><td>康熙</td></tr><tr><td>ackson</td><td>4</td><td>承祜</td></tr></tbody></table>', '選區不閉合');
            }
            setTimeout(function () {
                document.getElementById('edui_fixedlayer').parentNode.removeChild(document.getElementById('edui_fixedlayer'));
                te.dom.push(editor.container);
