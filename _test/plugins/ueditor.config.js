...
//    equal( UE.getUEBasePath( 'https://www.baidu.com/', './ueditor.config.js' ), 'https://www.baidu.com/', 'WEB路徑-當前目錄下' );
//    equal( UE.getUEBasePath( 'https://www.baidu.com/abc/def/', '../ueditor.config.js' ), 'https://www.baidu.com/abc/', 'WEB路徑-父目錄1' );
//    equal( UE.getUEBasePath( 'https://www.baidu.com/abc/def', '../ueditor.config.js' ), 'https://www.baidu.com/', 'WEB路徑-父目錄2' );
//
...
//
//    equal( UE.getUEBasePath( 'https://www.baidu.com/ueditor/completedemo.html', '/ueditorphp/ueditor.config.js' ), 'https://www.baidu.com/ueditorphp/', 'WEB路徑-當前目錄下' );
} );