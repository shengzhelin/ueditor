...
//        this.body.style.backgroundImage = '/ueditor/php/upload//8721363160868.gif';
        setTimeout(function(){
            ...
            equal(ua.formatColor(editor.body.style.backgroundColor),'#d7e3bc','檢查body背景色');

//            equal(editor.body.style.backgroundImage,'','檢查body背景圖片');
...
test( ' trace 3751 3748 設置 背景色', function() {
    var editor = te.obj[0];
