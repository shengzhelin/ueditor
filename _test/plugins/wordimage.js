...
test('檢查取得word_img的url地址', function () {
    var editor = te.obj[0];
    ...
    setTimeout(function () {
        ...
        equal(editor.body.getElementsByTagName('img')[0].getAttribute('word_img'), "file:///C:DOCUME~1DONGYA~1LOCALS~1Tempmsohtmlclip1clip_image001.gif", '檢查url地址');
        ...
        setTimeout(function () {
            editor.execCommand('wordimage', 'word_img');
//            equal(editor.word_img.length, '2', '有2個wordimg');
            equal(editor.body.getElementsByTagName('img')[0].getAttribute('word_img'), "file:///C:\DOCUME~1\DONGYA~1\LOCALS~1\Temp\msohtmlclip1\01\clip_image001.jpg", '檢查 第一個url地址');
            equal(editor.body.getElementsByTagName('img')[1].getAttribute('word_img'), "file:///C:\DOCUME~1\DONGYA~1\LOCALS~1\Temp\msohtmlclip1\01\clip_image001.gif", '檢查 第二個url地址');
...
test('多實例編輯器檢查取得word_img的url地址', function () {
...
//                equal(editor1.word_img.length, '1', 'editor1有一個wordimg');
                equal(editor1.body.getElementsByTagName('img')[0].getAttribute('word_img'), "file:///C:DOCUME~1DONGYA~1LOCALS~1Tempmsohtmlclip1clip_image001.gif", '檢查url地址');
                editor2.execCommand('wordimage', 'word_img');
//                equal(editor2.word_img.length, '2', 'editor2有2個wordimg');
                equal(editor2.body.getElementsByTagName('img')[0].getAttribute('word_img'), "file:///C:\DOCUME~1\DONGYA~1\LOCALS~1\Temp\msohtmlclip1\01\clip_image001.jpg", '檢查 第一個url地址');
                equal(editor2.body.getElementsByTagName('img')[1].getAttribute('word_img'), "file:///C:\DOCUME~1\DONGYA~1\LOCALS~1\Temp\msohtmlclip1\01\clip_image001.gif", '檢查 第二個url地址');
