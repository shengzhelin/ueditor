...
//        equal(tableButton.popup.getDom().style.display, '', '窗口顯示');
//
////  onmore
//        ua.click(document.getElementsByClassName('edui-clickable')[0]);
//        equal(tableButton.popup.getDom().style.display, "none", 'onmore 關閉窗口');
//
////    MouseOver
//        tableButton.showPopup();
//
...
//        var cellSize = tableButton.popup.content.lengthOfCellSide;//單元格的大小
...
//        //  行列的計算：  鼠標和"edui-pickarea"的相對位置/單元格大小
...
////    onclick
//        ua.click(pickarea);
//        equal(tableButton.popup.getDom().style.display, "none", 'onclick 關閉窗口');
//        start();
//    });
});