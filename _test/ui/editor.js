    ...
    ue.ready(function(){
        ...
        setTimeout(function(){
            ...
            setTimeout(function(){
                ...
                equal(parseInt($(this.document.getElementById(me.ui.id)).css('width')),parseInt(editorWidth) + offset - 2 -editorBorderHeight + border,'寬');
...
test('編輯器皮膚',function(){
    ...
    ue1.ready(function(){
        ...
        equal(document.getElementById('sc1').firstChild.className,'edui-editor  edui-default','第一個editor的classname');
        equal(document.getElementById(id+'_toolbarbox').className,'edui-editor-toolbarbox edui-default','第一個editor toolbar的classname');
        equal(document.getElementById(id+'_iframeholder').className,'edui-editor-iframeholder edui-default','第一個editor iframeholder的classname');
        equal(document.getElementById(id+'_bottombar').className,'edui-editor-bottomContainer edui-default','第一個editor bottombar的classname');
        equal(document.getElementById(id+'_scalelayer').className,'edui-default','第一個editor scalelayer的classname');
        ...
        ue2.ready(function(){
            ...
            equal(document.getElementById('sc2').firstChild.className,'edui-editor  edui-modern','第二個editor的classname');
            equal(document.getElementById(id+'_toolbarbox').className,'edui-editor-toolbarbox edui-modern','第二個editor toolbar的classname');
            equal(document.getElementById(id+'_iframeholder').className,'edui-editor-iframeholder edui-modern','第二個editor iframeholder的classname');
            equal(document.getElementById(id+'_bottombar').className,'edui-editor-bottomContainer edui-modern','第二個editor bottombar的classname');
            equal(document.getElementById(id+'_scalelayer').className,'edui-modern','第二個editor scalelayer的classname');
...
test( '判斷render有內容時，顯示render內容(script)', function() {
...
test( 'render沒有內容時，顯示initialContent', function() {
...
test('判斷dialogs對象名包含"Dialog"字符', function(){
...
//                ok(left==$(me).offset().left,'left不變'+$(me).offset().left);
//                ok(top==$(me).offset().top,'top不變'+$(me).offset().top);
//                ue6.focus();
