...
const Index=props=>{
  ...
  return <div className="tree-table-layout">
    <div className="left-tree">
      <Search placeholder="請輸入名稱" allowClear enterButton onSearch={searchTree} />
    ...
    <div className="right-table">
      <div className="search-bar">
        ...
        <Button type="primary" onClick={()=>update({period:[searchValue.begin,searchValue.end],hostid:selected.hostid})} icon={<SearchOutlined />}>查詢</Button>
        <Button style={{marginLeft:12}} disabled={!checkedKeys.length} loading={loading} onClick={()=>expGraph()} icon={<DownloadOutlined />}>導出</Button>
      </div>
