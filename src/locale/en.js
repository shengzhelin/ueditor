export default {
    ...
    drag:{
        ...
        pasteMustKeybordAlert:"在表格中進行覆制粘貼: Ctrl + C 進行覆制, Ctrl + V 進行粘貼, Ctrl + X 進行剪切",
        pasteMustKeybordAlertHTMLTitle:"在表格中進行覆制粘貼",
        pasteMustKeybordAlertHTML:"<span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + C</span>&nbsp;&nbsp;進行覆制<br/><span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + V</span>&nbsp;&nbsp;進行粘貼<br/><span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + X</span>&nbsp;&nbsp;進行剪切",
    },
    pivotTable:{
        title:"Pivot Table",
        closePannel:"Close",
