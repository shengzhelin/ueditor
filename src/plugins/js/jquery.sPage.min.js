/* jQuery分頁插件sPage  version:1.2.2  github:https://github.com/jvbei/sPage */
(function (p, t, e, a) {
    "use strict";
    var s = {
        page: 1,
    ...
    p.extend(i.prototype, {
        ...
        viewHtml: function () {
            ...
            if (t.selectOption.length > 0) {
                ...
                for (var i = 0; i <= t.selectOption.length - 1; i++) {
                    ...
                    if (t.pageSize === t.selectOption[i]) {
                        str += 'selected' + '>' + t.selectOption[i] + '行/頁</option>'
                    } else {
                        str += '>' + t.selectOption[i] + '行/頁</option>'
                    }
                }
                str += '</select>'
                a.push(str);
            ...
            if (t.showSkip) {
                a.push('<div class="spage-skip">跳至&nbsp;<input type="text" class="luckysheet-mousedown-cancel" value="' + t.page + '"/>&nbsp;頁&nbsp;&nbsp;</div>')
            }
