 ...
 * @param {string} direction 哪個方向插入 ['lefttop','rightbottom'] 之一
 * @param {string | number} sheetIndex 操作的 sheet 的 index 屬性
 * @returns 
 */
            ...
            if (cellBorderConfig.length) {
                ...
                cellBorderConfigCopy.forEach(item=>{
                    if (direction === 'rightbottom') {
                        ...
                        // 向上插入時 目標行移動到後面 新增n行到前面 對於新增的行來說 也是遞增，不過是從0開始
            ...
            for (let i = 0; i < value; i++) {
                ...
                cellBorderConfigCopy.forEach(item=>{
                    if (direction === 'rightbottom') {
                        ...
                        // 向左插入時 目標列移動到後面 新增n列到前面 對於新增的列來說 也是遞增，不過是從0開始
