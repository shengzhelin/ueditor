...
const editor = {
    ...
    webWorkerFlowDataCache:function(flowData){
        ...
        try{
            if(_this.deepCopyFlowDataWorker != null){//存新的webwork前先銷毀以前的
                _this.deepCopyFlowDataWorker.terminate();
            }
