...
export default function luckysheetsizeauto(isRefreshCanvas=true) {
    ...
    if(luckysheetConfigsetting.showConfigWindowResize){//數據透視表  圖表  交替顏色 Protection
    ...
    if(ismore){
        ...
        $("#luckysheet-icon-morebtn").click(function(){
            ...
            // *這里計算containerLeft的作用是：獲得容器左側的margin值，以讓點擊出現的“更多按鈕”欄位置不會出錯。
...
export function menuToolBarWidth() {
    ...
    /**
     * 基於 showtoolbarConfig 配置 動態生成 toolbarConfig
     * @returns {object}
