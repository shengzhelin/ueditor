...
function labelFilterOptionState($top, optionstate, rowhidden, caljs, notSave, str, edr, cindex, stc, edc) {
    if (optionstate) {
        ...
        $top.data("byconditionvalue", "null").data("byconditiontype", "0").data("byconditiontext", "無").data("byconditionvalue1", "").data("byconditionvalue2", "");
    }
    ...
    $("#luckysheet-cell-main").on("click", ".luckysheet-filter-options", function (e) {
        ...
        setTimeout(function () {
            ...
            for (let r = st_r + 1; r <= ed_r; r++) {
                ...
                if(cell != null && !isRealNull(cell.v) && cell.ct != null && cell.ct.t == "d" ){ //單元格是日期
    ...
    $("#luckysheet-filter-orderby-color").hover(
        function(){
            ...
            for (let r = st_r + 1; r <= ed_r; r++) {
                ...
                if(checksAF != null){//若單元格有交替顏色
                    bg = checksAF[1];
                }
    
                let checksCF = conditionformat.checksCF(r, cindex, cf_compute);
                if(checksCF != null && checksCF["cellColor"] != null){//若單元格有條件格式
                ...
                if(checksCF != null && checksCF["textColor"] != null){//若單元格有條件格式
    ...
    $("#luckysheet-filter-confirm").click(function () {
        ...
        if ($("#luckysheet-filter-bycondition").next().is(":visible") && $("#luckysheet-filter-byvalue").next().is(":hidden") && $("#luckysheet-filter-selected span").data("value") != "null") {
            ...
            for (let r = st_r + 1; r <= ed_r; r++) {
                ...
                if (value == "cellnull") { //單元格為空
                    if(cell != null && !isRealNull(cell.v)){
                        rowhidden[r] = 0;
                    }
                }
                else if (value == "cellnonull") { //單元格有數據
                    if(cell == null || isRealNull(cell.v)){
                        rowhidden[r] = 0;
                    }
                }
                ...
                else if (value == "datelessthan") { //日期早於
                    let value1 = genarate(caljs["value1"])[2];
                ...
                else if (value == "datemorethan") { //日期晚於
                    let value1 = genarate(caljs["value1"])[2];
                ...
                else if (value == "moreequalthan") { //大於等於
                    let value1 = parseFloat(caljs["value1"]);
                ...
                else if (value == "lessequalthan") { //小於等於
                    let value1 = parseFloat(caljs["value1"]);
