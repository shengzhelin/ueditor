...
const pivotTable = {
    ...
    luckysheetsliderlistitemfilter: function ($filter) {
        ...
        setTimeout(function () {
            ...
            for (let r = 1; r < data.length; r++) {
                ...
                if(cell != null && cell.ct != null && cell.ct.t == "d"){ //單元格是日期
    ...
    changePivotTable: function (index) {
        ...
        _this.refreshPivotTable(); //初始化在一個普通sheet頁，從此普通sheet頁切換到數據透視表頁時，需要刷新下數據，否則還是舊數據
    },
    refreshPivotTable: function (isRefreshCanvas=true) {
        ...
        redo["data"] = editor.deepCopyFlowData(Store.flowdata);//取數據
