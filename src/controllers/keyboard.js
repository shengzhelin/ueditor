    ...
    $("#luckysheet-input-box").click(function () {
        ...
        if((altKey || event.metaKey) && kcode == keycode.ENTER && parseInt($inputbox.css("top")) > 0){
            ...
            if (ctrlKey || event.metaKey) {
                ...
                else if (kcode == 72) {//Ctrl + H  替換
                    searchReplace.createDialog(1);
                    searchReplace.init();

                    $("#luckysheet-search-replace #searchInput input").focus();
                }
                else if (kcode == 73) {//Ctrl + I  斜體
                    $("#luckysheet-icon-italic").click();
                }
                else if (kcode == 86) {//Ctrl + V  粘貼
                    if (isEditMode() || Store.allowEdit === false){//此模式下禁用粘貼
                        return;
                    }
                ...
                else if (kcode == keycode.UP) {//Ctrl + up  調整單元格
                    if (parseInt($inputbox.css("top")) > 0 || $("#luckysheet-singleRange-dialog").is(":visible") || $("#luckysheet-multiRange-dialog").is(":visible")) {
                        return;
                    }
                ...
                else if (kcode == keycode.DOWN) {//Ctrl + down  調整單元格
                    if (parseInt($inputbox.css("top")) > 0 || $("#luckysheet-singleRange-dialog").is(":visible") || $("#luckysheet-multiRange-dialog").is(":visible")) {
                        return;
                    }
                ...
                else if (kcode == keycode.LEFT) {//Ctrl + top  調整單元格
                    if (parseInt($inputbox.css("top")) > 0 || $("#luckysheet-singleRange-dialog").is(":visible") || $("#luckysheet-multiRange-dialog").is(":visible")) {
                        return;
                    }
                ...
                else if (kcode == keycode.RIGHT) {//Ctrl + right  調整單元格
                    if (parseInt($inputbox.css("top")) > 0 || $("#luckysheet-singleRange-dialog").is(":visible") || $("#luckysheet-multiRange-dialog").is(":visible")) {
                        return;
                    }
                ...
                else if (String.fromCharCode(kcode).toLocaleUpperCase() == "A") {//Ctrl + A  全選
