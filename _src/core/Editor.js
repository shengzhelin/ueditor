...
(function () {
    ...
    Editor.prototype = {
         ...
         * @method ready
         * @param { Function } fn 編輯器ready之後所執行的回調, 如果在注冊事件之前編輯器已經ready，將會
         * 立即觸發該回調。
...
//                    scrolling :'no',
                ...
                setTimeout(function(){
                    if( /%$/.test(options.initialFrameWidth)){
                        options.minFrameWidth = options.initialFrameWidth = container.offsetWidth;
                        //如果這里給定寬度，會導致ie在拖動窗口大小時，編輯區域不隨著變化
//                        container.style.width = options.initialFrameWidth + 'px';
         ...
         * @return { String } 編輯器的內容字符串, 如果編輯器的內容為空，或者是空的標簽內容（如:”&lt;p&gt;&lt;br/&gt;&lt;/p&gt;“）， 則返回空字符串
         * @example
         * ```javascript
...
//            }
            ...
            _selectionChangeTimer = setTimeout(function () {
                ...
                //IE下如果用戶是拖拽一段已選擇文本，則不會觸發mouseup事件，所以這里的特殊處理不會對其有影響
                var ieRange;
        ...
        execCommand: function (cmdName) {
            ...
            if (!cmd.notNeedUndo && !me.__hasEnterExecCommand) {
                ...
                if (me.queryCommandState.apply(me,arguments) != -1) {
                    ...
                    //保存場景時，做了內容對比，再看是否進行contentchange觸發，這里多觸發了一次，去掉
//                    (!cmd.ignoreContentChange && !me._ignoreContentChange) && me.fireEvent('contentchange');
         ...
         * @return { Number } 返回計算的長度，內容中有hr/img/iframe標簽，長度加1
         * @example
         * ```javascript
         * //編輯器html內容<p><strong>132</strong></p>
