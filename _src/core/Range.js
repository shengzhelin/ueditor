...
(function () {
    ...
    Range.prototype = {
         ...
         *
         *         //這里的公共祖先節點是B而不是I， 是因為參數限制了獲取到的節點不能是容器節點
         *         //output: B
         *         console.log( node.tagName );
         *
         *     </script>
         ...
         *  @param { BookMark } bookmark createBookmark所創建的標簽對象
         *  @return { UE.dom.Range } 當前range對象
        ...
        /**
         * 給range選區中的內容添加給定的inline標簽， 並且為標簽附加上一些初始化屬性。
         * @method applyInlineStyle
         * @param { String } tagName 需要添加的標簽名
         * @param { Object } attrs 跟隨新添加的標簽的屬性
        ...
        /**
         * 移除當前選區內指定的一組inline標簽，但保留其中的內容
         * @method removeInlineStyle
         * @param { Array } tagNameArr 需要移除的標簽名的數組
         * @return { UE.dom.Range } 當前的range對象
...
//
                ...
                //是createAddress最後一位算的不準，現在這里進行微調
                checkOffset(this);
