 ...
 * @method execCommand
 * @remind 需要百度APPKey
 * @remind 百度應用主頁： <a href="http://app.baidu.com/" target="_blank">http://app.baidu.com/</a>
 * @param { Object } appOptions 應用所需的參數項， 支持的key有： title=>應用標題， width=>應用容器寬度，
 * height=>應用容器高度，logo=>應用logo，url=>應用地址
 * @example
 * ```javascript
 * //editor是編輯器實例
 * //在編輯器里插入一個“植物大戰僵屍”的APP
