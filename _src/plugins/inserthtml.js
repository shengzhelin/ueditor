 ...
 * @remaind 插入的標簽內容是在當前的選區位置上插入，如果當前是閉合狀態，那直接插入內容， 如果當前是選中狀態，將先清除當前選中內容後，再做插入
 * @warning 注意:該命令會對當前選區的位置，對插入的內容進行過濾轉換處理。 過濾的規則遵循html語意化的原則。
 * @example
 * ```javascript
 * //xxx[BB]xxx 當前選區為非閉合選區，選中BB這兩個文本
 * //執行命令，插入<b>CC</b>
 * //插入後的效果 xxx<b>CC</b>xxx
 * //<p>xx|xxx</p> 當前選區為閉合狀態
 * //插入<p>CC</p>
 * //結果 <p>xx</p><p>CC</p><p>xxx</p>
 * //<p>xxxx</p>|</p>xxx</p> 當前選區在兩個p標簽之間
 * //插入 xxxx
            ...
            while ( child = div.firstChild ) {
                ...
                if ( !hadBreak && child.nodeType == domUtils.NODE_ELEMENT && domUtils.isBlockElm( child ) ){
                    ...
                    if ( parent && parent.tagName.toLowerCase() != 'body' && !(dtd[parent.tagName][child.nodeName] && child.parentNode === parent)){
                        ...
                        //去掉break後前一個多余的節點  <p>|<[p> ==> <p></p><div></div><p>|</p>
                        var pre = child.previousSibling;
                        domUtils.trimWhiteTextNode(pre);
                        if(!pre.childNodes.length){
                            domUtils.remove(pre);
                        }
                        //trace:2012,在非ie的情況，切開後剩下的節點有可能不能點入光標添加br占位
