...
'配置
'MAX_SIZE 在這里設定了之後如果出現大上傳失敗，請執行以下步驟
'IIS 6 
    '找到位於 C:\Windows\System32\Inetsrv 中的 metabase.XML 打開，找到ASPMaxRequestEntityAllowed 把他修改為需要的值（如10240000即10M）
'IIS 7
    '打開IIS控制台，選擇 ASP，在限制屬性里有一個“最大請求實體主題限制”，設置需要的值
