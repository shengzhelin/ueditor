...
(function() {
  ...
  window.UEDITOR_CONFIG = {
    ...
    //,autoClearinitialContent:true //是否自動清除編輯器初始內容，注意：如果focus屬性設置為true,這個也為真，那麽編輯器一上來就會觸發導致初始化的內容看不到了
    ...
    //右鍵選單的內容，可以參考plugins/contextmenu.js里邊的默認選單的例子，label留空支持國際化，否則以此配置為準
    //,contextMenu:[
    //    {
    //        label:'',       //顯示的名稱
    ...
    //tab
    //點擊tab鍵時移動的距離,tabSize倍數，tabNode什麽字符做為單位
    //,tabSize:4
    //,tabNode:'&nbsp;'
